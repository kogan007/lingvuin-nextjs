...
function ms(val, options = { long: true }, locale = "en-US") {
  options = options || {};
  var type = typeof val;
...
function plural(ms, msAbs, n, name, translation) {
  var isPlural = msAbs >= n * 1.5;
  let nameTranslated = translation.slavic
    ? translation[name].nomSingular
    : translation[name];
